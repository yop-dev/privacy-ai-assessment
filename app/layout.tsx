...
<header className="sticky top-0 z-50 bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-lg">
  ...
  <div className="absolute inset-0 bg-gradient-to-r from-primary-50/30 via-transparent to-blue-50/30 pointer-events-none"></div>
    ...
    <div className="flex justify-between items-center py-4">
      ...
      <Link href="/" className="group flex items-center space-x-4 hover:scale-105 transition-all duration-300">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 rounded-2xl border-2 border-primary-300 opacity-0 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300"></div>
        </div>
      ...
      <nav className="hidden md:flex items-center space-x-1">
        <Link href="/" className="nav-link group relative px-4 py-2 rounded-xl font-medium text-gray-700 hover:text-primary-700 hover:bg-primary-50/50 transition-all duration-200">
          <span className="relative z-10">Home</span>
          <div className="absolute inset-0 bg-gradient-to-r from-primary-500/10 to-blue-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
        </Link>
        
        
        <Link href="/resources" className="nav-link group relative px-4 py-2 rounded-xl font-medium text-gray-700 hover:text-primary-700 hover:bg-primary-50/50 transition-all duration-200">
        ...
        <a 
          ...
          className="nav-link group relative px-4 py-2 rounded-xl font-medium text-gray-700 hover:text-primary-700 hover:bg-primary-50/50 transition-all duration-200"
        >
          <span className="relative z-10 flex items-center">
            <svg className="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Mobile Menu Button */}
      <button className="md:hidden p-2 rounded-xl bg-gray-100 hover:bg-gray-200 transition-colors duration-200">
