...
{/* AI Assistant Chatbot Section - Seamless transition */}
        ...
        <section className="py-20 bg-gray-50 relative border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Principles in a responsive grid layout */}
            <ScrollReveal direction="up" delay={0.2} distance={40}>
              <StaggeredList className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-12" staggerDelay={0.1}>
                <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 mb-4 leading-relaxed text-sm">Data subjects must be informed about data collection, processing, and use in clear, understandable terms.</p>
                      <div className="bg-gray-50 rounded-lg p-4">
                        <ul className="text-xs text-gray-600 space-y-2">
                          ...
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-primary-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                            Must include purpose, legal basis, retention period, and data subject rights
                          </li>
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-primary-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                            Updates to privacy practices must be communicated promptly
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-gray-900 mb-3">Legitimate Purpose</h3>
                      <p className="text-gray-700 mb-4 leading-relaxed text-sm">Personal data must be collected and processed for specified, legitimate purposes only.</p>
                      <div className="bg-gray-50 rounded-lg p-4">
                        <ul className="text-xs text-gray-600 space-y-2">
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                            Purposes must be clearly defined before data collection
                          </li>
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                            Cannot use data for purposes incompatible with original intent
                          </li>
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                            Must have valid legal basis (consent, contract, legal obligation, etc.)
                          </li>
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                            Regular review of processing activities to ensure ongoing legitimacy
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-gray-900 mb-3">Proportionality</h3>
                      <p className="text-gray-700 mb-4 leading-relaxed text-sm">Data collection and processing should be proportionate to the declared purpose.</p>
                      <div className="bg-gray-50 rounded-lg p-4">
                        <ul className="text-xs text-gray-600 space-y-2">
                          <li className="flex items-start">
                          ...
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                            Avoid excessive data collection beyond stated purposes
                          </li>
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                          ...
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-1.5 mr-2 flex-shrink-0"></span>
                            Regular assessment of data necessity and relevance
                          </li>
                        </ul>
                      </div>
                    </div>
            ...
            {/* RA 10173 Structure Overview - Full width below principles */}
            <ScrollReveal direction="up" delay={0.4} distance={40}>
