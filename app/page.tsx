...
export default function HomePage() {
  ...
  return (
    ...
    <div>
      {/* Hero Section */}
      <GradientBackground variant="primary" intensity="medium" animated={true}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <StaggeredList className="grid sm:grid-cols-3 gap-8 max-w-4xl mx-auto" staggerDelay={0.2}>
              <ScrollReveal direction="scale" delay={0.1} threshold={0.3}>
              ...
              <ScrollReveal direction="scale" delay={0.2} threshold={0.3}>
                <div className="text-center">
              ...
              <ScrollReveal direction="scale" delay={0.3} threshold={0.3}>
                <div className="text-center">
      ...
      <GradientBackground variant="secondary" intensity="medium" animated={true}>
        <PatternBackground pattern="dots" opacity={0.05}>
          <section className="py-20 relative overflow-hidden">
        <ParallaxSection speed={0.3} className="absolute inset-0 opacity-10">
          <div className="w-full h-full bg-gradient-to-r from-primary-200 to-blue-200"></div>
        </ParallaxSection>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <ScrollReveal direction="up" delay={0.2} distance={80}>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-green-200">
              <div className="flex items-center justify-center mb-6">
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600">Get instant answers about RA 10173 compliance and requirements</p>
                </div>
              </div>
              ...
              <ScrollReveal direction="scale" delay={0.4}>
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-xs text-gray-500 mt-3 text-center">
                    Or use the floating chat button in the bottom-right corner
                  </p>
                </div>
              </ScrollReveal>
            </div>
      ...
      {/* About Section */}
      <GradientBackground variant="neutral" intensity="subtle" animated={true}>

        <PatternBackground pattern="grid" opacity={0.03}>
          <section className="py-20 relative overflow-hidden">
        <ParallaxSection speed={-0.2} className="absolute top-0 left-0 w-full h-32 opacity-5">
          <div className="w-full h-full bg-gradient-to-b from-primary-100 to-transparent"></div>
        </ParallaxSection>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <ScrollReveal direction="scale" delay={0.2} duration={1}>
              <div className="mb-16 text-center">
                ...
                <div className="max-w-4xl mx-auto">
                  <img 
                    ...
                    className="w-full h-auto rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-500"
                  />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <ScrollReveal direction="left" delay={0.3} distance={80}>
                <div>
